...
set_property(TARGET poco_DEPS_TARGET
             ...
             $<$<CONFIG:Release>:Poco::Foundation;openssl::openssl;Poco::Data;libmysqlclient::libmysqlclient;PostgreSQL::PostgreSQL;SQLite::SQLite3;pcre::pcre;ZLIB::ZLIB;Poco::JSON;Poco::Crypto;Poco::Net;Poco::Util;Poco::XML;expat::expat>
             APPEND)
...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT Poco::NetSSL #############
        ...
        set_property(TARGET Poco::NetSSL PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_NetSSL_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Poco::NetSSL PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_NetSSL_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::NetSSL PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_NetSSL_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::NetSSL PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${poco_Poco_NetSSL_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Poco::NetSSL PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_NetSSL_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT Poco::Zip #############
        ...
        set_property(TARGET Poco::Zip PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_Zip_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Poco::Zip PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_Zip_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::Zip PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_Zip_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::Zip PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${poco_Poco_Zip_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Poco::Zip PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_Zip_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT Poco::Util #############
        ...
        set_property(TARGET Poco::Util PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_Util_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Poco::Util PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_Util_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::Util PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_Util_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::Util PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${poco_Poco_Util_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Poco::Util PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_Util_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT Poco::MongoDB #############
        ...
        set_property(TARGET Poco::MongoDB PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_MongoDB_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Poco::MongoDB PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_MongoDB_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::MongoDB PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_MongoDB_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::MongoDB PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${poco_Poco_MongoDB_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Poco::MongoDB PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_MongoDB_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT Poco::JWT #############
        ...
        set_property(TARGET Poco::JWT PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_JWT_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Poco::JWT PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_JWT_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::JWT PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_JWT_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::JWT PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${poco_Poco_JWT_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Poco::JWT PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_JWT_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT Poco::Encodings #############
        ...
        set_property(TARGET Poco::Encodings PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_Encodings_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Poco::Encodings PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_Encodings_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::Encodings PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_Encodings_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::Encodings PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${poco_Poco_Encodings_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Poco::Encodings PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_Encodings_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT Poco::DataSQLite #############
        ...
        set_property(TARGET Poco::DataSQLite PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_DataSQLite_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Poco::DataSQLite PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_DataSQLite_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::DataSQLite PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_DataSQLite_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::DataSQLite PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${poco_Poco_DataSQLite_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Poco::DataSQLite PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_DataSQLite_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT Poco::DataPostgreSQL #############
        ...
        set_property(TARGET Poco::DataPostgreSQL PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_DataPostgreSQL_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Poco::DataPostgreSQL PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_DataPostgreSQL_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::DataPostgreSQL PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_DataPostgreSQL_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::DataPostgreSQL PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${poco_Poco_DataPostgreSQL_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Poco::DataPostgreSQL PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_DataPostgreSQL_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT Poco::DataMySQL #############
        ...
        set_property(TARGET Poco::DataMySQL PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_DataMySQL_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Poco::DataMySQL PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_DataMySQL_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::DataMySQL PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_DataMySQL_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::DataMySQL PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${poco_Poco_DataMySQL_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Poco::DataMySQL PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_DataMySQL_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT Poco::Data #############
        ...
        set_property(TARGET Poco::Data PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_Data_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Poco::Data PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_Data_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::Data PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_Data_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::Data PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${poco_Poco_Data_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Poco::Data PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_Data_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT Poco::Crypto #############
        ...
        set_property(TARGET Poco::Crypto PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_Crypto_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Poco::Crypto PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_Crypto_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::Crypto PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_Crypto_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::Crypto PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${poco_Poco_Crypto_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Poco::Crypto PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_Crypto_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT Poco::XML #############
        ...
        set_property(TARGET Poco::XML PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_XML_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Poco::XML PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_XML_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::XML PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_XML_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::XML PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${poco_Poco_XML_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Poco::XML PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_XML_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT Poco::Redis #############
        ...
        set_property(TARGET Poco::Redis PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_Redis_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Poco::Redis PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_Redis_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::Redis PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_Redis_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::Redis PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${poco_Poco_Redis_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Poco::Redis PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_Redis_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT Poco::Net #############
        ...
        set_property(TARGET Poco::Net PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_Net_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Poco::Net PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_Net_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::Net PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_Net_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::Net PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${poco_Poco_Net_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Poco::Net PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_Net_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT Poco::JSON #############
        ...
        set_property(TARGET Poco::JSON PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_JSON_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Poco::JSON PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_JSON_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::JSON PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_JSON_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::JSON PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${poco_Poco_JSON_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Poco::JSON PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_JSON_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    ########## COMPONENT Poco::Foundation #############
        ...
        set_property(TARGET Poco::Foundation PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_Foundation_LINKER_FLAGS_RELEASE}> APPEND)
        set_property(TARGET Poco::Foundation PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_Foundation_INCLUDE_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::Foundation PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${poco_Poco_Foundation_LIB_DIRS_RELEASE}> APPEND)
        set_property(TARGET Poco::Foundation PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${poco_Poco_Foundation_COMPILE_DEFINITIONS_RELEASE}> APPEND)
        set_property(TARGET Poco::Foundation PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${poco_Poco_Foundation_COMPILE_OPTIONS_RELEASE}> APPEND)
    ...
    set_property(TARGET Poco::Poco PROPERTY INTERFACE_LINK_LIBRARIES Poco::DataMySQL APPEND)
